 ...
 * <ul>
 *   <li>{@link type.impl.BooleanValueImpl#isValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanValueImpl extends ValueImpl implements BooleanValue {
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.BOOLEAN_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypePackage.BOOLEAN_VALUE__VALUE:
				return isValue();
		}
