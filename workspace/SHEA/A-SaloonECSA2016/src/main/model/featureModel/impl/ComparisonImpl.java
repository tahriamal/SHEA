 ...
 * <ul>
 *   <li>{@link featureModel.impl.ComparisonImpl#getFrom <em>From</em>}</li>
 *   <li>{@link featureModel.impl.ComparisonImpl#getTo <em>To</em>}</li>
 *   <li>{@link featureModel.impl.ComparisonImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComparisonImpl extends FMConstraintImpl implements Comparison {
	...
	protected EClass eStaticClass() {
		return FeatureModelPackage.Literals.COMPARISON;
	}
		...
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FeatureModelPackage.COMPARISON__FROM, oldFrom, from));
			}
		}
		return from;
	}
	...
	public void setFrom(FMElement newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.COMPARISON__FROM, oldFrom, from));
	}
	...
	public FMElement getTo() {
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FeatureModelPackage.COMPARISON__TO, oldTo, to));
			}
		}
		return to;
	}
	...
	public void setTo(FMElement newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.COMPARISON__TO, oldTo, to));
	}
	...
	public void setType(ComparisonOperator newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.COMPARISON__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FeatureModelPackage.COMPARISON__FROM:
				if (resolve) return getFrom();
				return basicGetFrom();
			case FeatureModelPackage.COMPARISON__TO:
				if (resolve) return getTo();
				return basicGetTo();
			case FeatureModelPackage.COMPARISON__TYPE:
				return getType();
		}
