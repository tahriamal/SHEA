 ...
 * <ul>
 *   <li>{@link EFM.impl.FeatureModelImpl#getConstraints <em>Constraints</em>}</li>
 *   <li>{@link EFM.impl.FeatureModelImpl#getRootFeature <em>Root Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureModelImpl extends MinimalEObjectImpl.Container implements FeatureModel {
	...
	protected EClass eStaticClass() {
		return EFMPackage.Literals.FEATURE_MODEL;
	}
	...
	public EList<FMConstraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<FMConstraint>(FMConstraint.class, this, EFMPackage.FEATURE_MODEL__CONSTRAINTS);
		}
		return constraints;
	}
	...
	public NotificationChain basicSetRootFeature(Feature newRootFeature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EFMPackage.FEATURE_MODEL__ROOT_FEATURE, oldRootFeature, newRootFeature);
	...
	public void setRootFeature(Feature newRootFeature) {
		if (newRootFeature != rootFeature) {
			...
			if (rootFeature != null)
				msgs = ((InternalEObject)rootFeature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EFMPackage.FEATURE_MODEL__ROOT_FEATURE, null, msgs);
			if (newRootFeature != null)
				msgs = ((InternalEObject)newRootFeature).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EFMPackage.FEATURE_MODEL__ROOT_FEATURE, null, msgs);
			msgs = basicSetRootFeature(newRootFeature, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EFMPackage.FEATURE_MODEL__ROOT_FEATURE, newRootFeature, newRootFeature));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EFMPackage.FEATURE_MODEL__CONSTRAINTS:
				return ((InternalEList<?>)getConstraints()).basicRemove(otherEnd, msgs);
			case EFMPackage.FEATURE_MODEL__ROOT_FEATURE:
