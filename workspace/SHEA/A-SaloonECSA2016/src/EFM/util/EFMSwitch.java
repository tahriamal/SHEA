 ...
 * @generated
 */
public class EFMSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EFMPackage.CARDINALITY: {
				Cardinality cardinality = (Cardinality)theEObject;
				T result = caseCardinality(cardinality);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EFMPackage.ATTRIBUTE: {
			...
			case EFMPackage.FEAT_CARDINALITY: {
			...
			case EFMPackage.OPERATION: {
				Operation operation = (Operation)theEObject;
				T result = caseOperation(operation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EFMPackage.RANGE_OPERATION: {
			...
			case EFMPackage.VALUE_OPERATION: {
			...
			case EFMPackage.RESOURCE_VERIFICATION: {
			...
			case EFMPackage.NODE_FEATURE_ELEMENT: {
