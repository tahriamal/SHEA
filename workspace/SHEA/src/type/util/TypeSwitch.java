...
public class TypeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TypePackage.TYPE_REPOSITORY: {
				TypeRepository typeRepository = (TypeRepository)theEObject;
				T result = caseTypeRepository(typeRepository);
			...
			case TypePackage.INT_VALUE: {
				...
				if (result == null) result = caseNumericValue(intValue);
			...
			case TypePackage.FLOAT_VALUE: {
				...
				if (result == null) result = caseNumericValue(floatValue);
				if (result == null) result = caseValue(floatValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TypePackage.ENUM_LIST_VALUE: {
				EnumListValue enumListValue = (EnumListValue)theEObject;
				T result = caseEnumListValue(enumListValue);
				if (result == null) result = caseValue(enumListValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case TypePackage.ENUM_VALUE: {
				EnumValue enumValue = (EnumValue)theEObject;
				T result = caseEnumValue(enumValue);
				if (result == null) result = caseIntValue(enumValue);
				if (result == null) result = caseNumericValue(enumValue);
	 ...
	 * @generated
	 */
	public T caseTypeRepository(TypeRepository object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Enum List Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Enum List Value</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEnumListValue(EnumListValue object) {
		return null;
	}
