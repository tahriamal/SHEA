 ...
 * <ul>
 *   <li>{@link type.impl.FloatValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FloatValueImpl extends NumericValueImpl implements FloatValue {
	...
	public void setValue(float newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.FLOAT_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypePackage.FLOAT_VALUE__VALUE:
				return getValue();
		}
