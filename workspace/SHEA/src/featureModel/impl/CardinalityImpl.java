 ...
 * <ul>
 *   <li>{@link featureModel.impl.CardinalityImpl#getCardinalityMin <em>Cardinality Min</em>}</li>
 *   <li>{@link featureModel.impl.CardinalityImpl#getCardinalityMax <em>Cardinality Max</em>}</li>
 *   <li>{@link featureModel.impl.CardinalityImpl#getConfigValue <em>Config Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CardinalityImpl extends MinimalEObjectImpl.Container implements Cardinality {
	...
	protected EClass eStaticClass() {
		return FeatureModelPackage.Literals.CARDINALITY;
	}
	...
	public void setCardinalityMin(int newCardinalityMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.CARDINALITY__CARDINALITY_MIN, oldCardinalityMin, cardinalityMin));
	}
	...
	public void setCardinalityMax(int newCardinalityMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.CARDINALITY__CARDINALITY_MAX, oldCardinalityMax, cardinalityMax));
	}
	...
	public void setConfigValue(int newConfigValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.CARDINALITY__CONFIG_VALUE, oldConfigValue, configValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FeatureModelPackage.CARDINALITY__CARDINALITY_MIN:
				return getCardinalityMin();
			case FeatureModelPackage.CARDINALITY__CARDINALITY_MAX:
				return getCardinalityMax();
			case FeatureModelPackage.CARDINALITY__CONFIG_VALUE:
