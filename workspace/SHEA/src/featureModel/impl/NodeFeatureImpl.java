 ...
 * <ul>
 *   <li>{@link featureModel.impl.NodeFeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link featureModel.impl.NodeFeatureImpl#getNodeAttributes <em>Node Attributes</em>}</li>
 *   <li>{@link featureModel.impl.NodeFeatureImpl#getNodeCardinalities <em>Node Cardinalities</em>}</li>
 *   <li>{@link featureModel.impl.NodeFeatureImpl#getHostedBy <em>Hosted By</em>}</li>
 *   <li>{@link featureModel.impl.NodeFeatureImpl#getNotHostedBy <em>Not Hosted By</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeFeatureImpl extends NodeFeatureElementImpl implements NodeFeature {
	...
	protected EClass eStaticClass() {
		return FeatureModelPackage.Literals.NODE_FEATURE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.NODE_FEATURE__NAME, oldName, name));
	}
	...
	public EList<Attribute> getNodeAttributes() {
		if (nodeAttributes == null) {
			nodeAttributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, FeatureModelPackage.NODE_FEATURE__NODE_ATTRIBUTES);
		}
	...
	public NotificationChain basicSetNodeCardinalities(FeatCardinality newNodeCardinalities, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FeatureModelPackage.NODE_FEATURE__NODE_CARDINALITIES, oldNodeCardinalities, newNodeCardinalities);
	...
	public void setNodeCardinalities(FeatCardinality newNodeCardinalities) {
		if (newNodeCardinalities != nodeCardinalities) {
			...
			if (nodeCardinalities != null)
				msgs = ((InternalEObject)nodeCardinalities).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FeatureModelPackage.NODE_FEATURE__NODE_CARDINALITIES, null, msgs);
			if (newNodeCardinalities != null)
				msgs = ((InternalEObject)newNodeCardinalities).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FeatureModelPackage.NODE_FEATURE__NODE_CARDINALITIES, null, msgs);
			msgs = basicSetNodeCardinalities(newNodeCardinalities, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.NODE_FEATURE__NODE_CARDINALITIES, newNodeCardinalities, newNodeCardinalities));
	}
	...
	public NotificationChain basicSetHostedBy(HostedBy newHostedBy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FeatureModelPackage.NODE_FEATURE__HOSTED_BY, oldHostedBy, newHostedBy);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHostedBy(HostedBy newHostedBy) {
		if (newHostedBy != hostedBy) {
			NotificationChain msgs = null;
			if (hostedBy != null)
				msgs = ((InternalEObject)hostedBy).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FeatureModelPackage.NODE_FEATURE__HOSTED_BY, null, msgs);
			if (newHostedBy != null)
				msgs = ((InternalEObject)newHostedBy).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FeatureModelPackage.NODE_FEATURE__HOSTED_BY, null, msgs);
			msgs = basicSetHostedBy(newHostedBy, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.NODE_FEATURE__HOSTED_BY, newHostedBy, newHostedBy));
	}
	...
	public NotificationChain basicSetNotHostedBy(NotHostedBy newNotHostedBy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FeatureModelPackage.NODE_FEATURE__NOT_HOSTED_BY, oldNotHostedBy, newNotHostedBy);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNotHostedBy(NotHostedBy newNotHostedBy) {
		if (newNotHostedBy != notHostedBy) {
			NotificationChain msgs = null;
			if (notHostedBy != null)
				msgs = ((InternalEObject)notHostedBy).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FeatureModelPackage.NODE_FEATURE__NOT_HOSTED_BY, null, msgs);
			if (newNotHostedBy != null)
				msgs = ((InternalEObject)newNotHostedBy).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FeatureModelPackage.NODE_FEATURE__NOT_HOSTED_BY, null, msgs);
			msgs = basicSetNotHostedBy(newNotHostedBy, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.NODE_FEATURE__NOT_HOSTED_BY, newNotHostedBy, newNotHostedBy));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FeatureModelPackage.NODE_FEATURE__NODE_ATTRIBUTES:
				return ((InternalEList<?>)getNodeAttributes()).basicRemove(otherEnd, msgs);
			case FeatureModelPackage.NODE_FEATURE__NODE_CARDINALITIES:
				return basicSetNodeCardinalities(null, msgs);
			case FeatureModelPackage.NODE_FEATURE__HOSTED_BY:
				return basicSetHostedBy(null, msgs);
			case FeatureModelPackage.NODE_FEATURE__NOT_HOSTED_BY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FeatureModelPackage.NODE_FEATURE__NAME:
				return getName();
			case FeatureModelPackage.NODE_FEATURE__NODE_ATTRIBUTES:
