 ...
 * <ul>
 *   <li>{@link EFM.impl.AlternativeImpl#getVariants <em>Variants</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AlternativeImpl extends FeatureImpl implements Alternative {
	...
	protected EClass eStaticClass() {
		return EFMPackage.Literals.ALTERNATIVE;
	}
	...
	public EList<Feature> getVariants() {
		if (variants == null) {
			variants = new EObjectContainmentEList<Feature>(Feature.class, this, EFMPackage.ALTERNATIVE__VARIANTS);
		}
		return variants;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EFMPackage.ALTERNATIVE__VARIANTS:
