 ...
 * <ul>
 *   <li>{@link EFM.impl.NotHostedByImpl#getExtF <em>Ext F</em>}</li>
 *   <li>{@link EFM.impl.NotHostedByImpl#getFrom <em>From</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NotHostedByImpl extends FMConstraintImpl implements NotHostedBy {
	...
	protected EClass eStaticClass() {
		return EFMPackage.Literals.NOT_HOSTED_BY;
	}
		...
		if (extF != null && extF.eIsProxy()) {
			...
			if (extF != oldExtF) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EFMPackage.NOT_HOSTED_BY__EXT_F, oldExtF, extF));
			}
		}
		return extF;
	}
	...
	public void setExtF(NodeFeature newExtF) {
		...
		extF = newExtF;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EFMPackage.NOT_HOSTED_BY__EXT_F, oldExtF, extF));
	}
	...
	public EList<Feature> getFrom() {
		if (from == null) {
			from = new EObjectResolvingEList<Feature>(Feature.class, this, EFMPackage.NOT_HOSTED_BY__FROM);
		}
		return from;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EFMPackage.NOT_HOSTED_BY__EXT_F:
				if (resolve) return getExtF();
				return basicGetExtF();
			case EFMPackage.NOT_HOSTED_BY__FROM:
				return getFrom();
		}
