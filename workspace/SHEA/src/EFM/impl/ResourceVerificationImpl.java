 ...
 * <ul>
 *   <li>{@link EFM.impl.ResourceVerificationImpl#getFromAtt <em>From Att</em>}</li>
 *   <li>{@link EFM.impl.ResourceVerificationImpl#getExtF <em>Ext F</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceVerificationImpl extends FMConstraintImpl implements ResourceVerification {
	...
	protected EClass eStaticClass() {
		return EFMPackage.Literals.RESOURCE_VERIFICATION;
	}
	...
	public EList<Attribute> getFromAtt() {
		if (fromAtt == null) {
			fromAtt = new EObjectResolvingEList<Attribute>(Attribute.class, this, EFMPackage.RESOURCE_VERIFICATION__FROM_ATT);
		}
		return fromAtt;
	}
		...
		if (extF != null && extF.eIsProxy()) {
			...
			if (extF != oldExtF) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EFMPackage.RESOURCE_VERIFICATION__EXT_F, oldExtF, extF));
			}
		}
		return extF;
	}
	...
	public void setExtF(Attribute newExtF) {
		...
		extF = newExtF;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EFMPackage.RESOURCE_VERIFICATION__EXT_F, oldExtF, extF));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EFMPackage.RESOURCE_VERIFICATION__FROM_ATT:
				return getFromAtt();
			case EFMPackage.RESOURCE_VERIFICATION__EXT_F:
