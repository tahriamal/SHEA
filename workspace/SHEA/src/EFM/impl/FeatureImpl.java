 ...
 * <ul>
 *   <li>{@link EFM.impl.FeatureImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link EFM.impl.FeatureImpl#getSubFeatures <em>Sub Features</em>}</li>
 *   <li>{@link EFM.impl.FeatureImpl#getFeatureCardinality <em>Feature Cardinality</em>}</li>
 *   <li>{@link EFM.impl.FeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link EFM.impl.FeatureImpl#getNodeFeature <em>Node Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureImpl extends FMElementImpl implements Feature {
	...
	protected EClass eStaticClass() {
		return EFMPackage.Literals.FEATURE;
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, EFMPackage.FEATURE__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public EList<Feature> getSubFeatures() {
		if (subFeatures == null) {
			subFeatures = new EObjectContainmentEList<Feature>(Feature.class, this, EFMPackage.FEATURE__SUB_FEATURES);
		}
		return subFeatures;
	}
	...
	public NotificationChain basicSetFeatureCardinality(FeatCardinality newFeatureCardinality, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EFMPackage.FEATURE__FEATURE_CARDINALITY, oldFeatureCardinality, newFeatureCardinality);
	...
	public void setFeatureCardinality(FeatCardinality newFeatureCardinality) {
		if (newFeatureCardinality != featureCardinality) {
			...
			if (featureCardinality != null)
				msgs = ((InternalEObject)featureCardinality).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EFMPackage.FEATURE__FEATURE_CARDINALITY, null, msgs);
			if (newFeatureCardinality != null)
				msgs = ((InternalEObject)newFeatureCardinality).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EFMPackage.FEATURE__FEATURE_CARDINALITY, null, msgs);
			msgs = basicSetFeatureCardinality(newFeatureCardinality, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EFMPackage.FEATURE__FEATURE_CARDINALITY, newFeatureCardinality, newFeatureCardinality));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EFMPackage.FEATURE__NAME, oldName, name));
	}
	...
	public EList<NodeFeature> getNodeFeature() {
		if (nodeFeature == null) {
			nodeFeature = new EObjectContainmentEList<NodeFeature>(NodeFeature.class, this, EFMPackage.FEATURE__NODE_FEATURE);
		}
		return nodeFeature;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EFMPackage.FEATURE__ATTRIBUTES:
				return ((InternalEList<?>)getAttributes()).basicRemove(otherEnd, msgs);
			case EFMPackage.FEATURE__SUB_FEATURES:
				return ((InternalEList<?>)getSubFeatures()).basicRemove(otherEnd, msgs);
			case EFMPackage.FEATURE__FEATURE_CARDINALITY:
				return basicSetFeatureCardinality(null, msgs);
			case EFMPackage.FEATURE__NODE_FEATURE:
