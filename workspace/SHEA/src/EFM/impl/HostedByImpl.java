 ...
 * <ul>
 *   <li>{@link EFM.impl.HostedByImpl#getFrom <em>From</em>}</li>
 *   <li>{@link EFM.impl.HostedByImpl#getTo <em>To</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HostedByImpl extends FMConstraintImpl implements HostedBy {
	...
	protected EClass eStaticClass() {
		return EFMPackage.Literals.HOSTED_BY;
	}
	...
	public EList<Feature> getFrom() {
		if (from == null) {
			from = new EObjectResolvingEList<Feature>(Feature.class, this, EFMPackage.HOSTED_BY__FROM);
		}
		return from;
	}
		...
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EFMPackage.HOSTED_BY__TO, oldTo, to));
			}
		}
		return to;
	}
	...
	public void setTo(NodeFeature newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EFMPackage.HOSTED_BY__TO, oldTo, to));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EFMPackage.HOSTED_BY__FROM:
				return getFrom();
			case EFMPackage.HOSTED_BY__TO:
